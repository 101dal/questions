Okay, voici un README complet pour le projet "Quiz Master (Local Version)", incluant la description, les fonctionnalités, le guide d'utilisation et le format JSON détaillé pour la création de quiz.
